...
<header>
    <div class="logo">
        <img src="backend/img/homepage/logosweetsoft.png" alt="Logo SweetSoft">
    </div>
    <div class="account-section">
        ...
        <a href="#account-but" class="acc-but"><p>Đăng nhập</p></a>
    </div>
</header>
        ...
        <div class="right-container">
            <div class="right-content">
                ...
                <div class="search-bar">
                    ...
                    <button>
                        <img src="backend/img/homepage/search.png" alt="Search Icon">
                    </button>
                </div>
            </div>
        </div>
...
<footer class="footer">
    <div class="footer-logo">
        <img src="backend/img/homepage/logosweetsoft.png" alt="Logo Footer">
    </div>
    <div class="footer-content">
        ...
        <div class="footer-section facebook">
            ...
            <div class="facebook-widget">
                <img src="backend/img/homepage/logosweetsoft.png" alt="Facebook Logo">
            </div>
        </div>
    </div>
