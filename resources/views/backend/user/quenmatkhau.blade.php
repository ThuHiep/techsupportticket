...
<head>
    ...
    <link rel="stylesheet" href="/techsupportticket/public/backend/css/forgot_password.css?v=1">
...
<script>
    document.querySelector('.input-submit').addEventListener('click', function(e) {
        ...
        window.location.href = "thongbaodaguimail.php"; // Chuyển hướng sang trang thông báo
    });
</script>
</body>
</html>
