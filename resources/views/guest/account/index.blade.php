...
<head>
    ...
    <!-- Main CSS File -->
    <link rel="stylesheet" href="guest/css/account/user.css?v=1">
...
<header id="header" class="header purple-background d-flex flex-column">
    ...
    <nav id="navmenu" class="navmenu">
        <ul>
            <li><a href="#hero" class="active"><i class="bi bi-house navicon"></i>Hồ sơ</a></li>
            <li><a href="#about"><i class="bi bi-person navicon"></i>Yêu cầu</a></li>
            <li><a href="#portfolio"><i class="bi bi-images navicon"></i> Thông báo</a></li>
        </ul>
    </nav>
